...
import { 
  BottomIcon, VideoIcon, ContentBox,
  VideoContainer, SuscribeBoxStyled, InfoBox,
  BoxLeft, BoxRight, Video,
  LeftImage, LeftTitle, Header,
  RightTop, TopWrapper, TopIcon,
  TopText, RightBottom, BottomText,
} from '../course.styles';
...
export const CourseHeader = ({course}: Props) => {
  ...
  return (
    <Header>
      ...
      <ContentBox>
        ...
        <SuscribeBoxStyled 
          title={{text: 'Anímate y comienza ahora!'}}
          button={{title: 'Ver clases', to: `/video/${course.slug}/1/`}}
          className="center"
        />
      </ContentBox>
    </Header>
